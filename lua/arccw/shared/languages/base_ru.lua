...
L["ui.loadpreset"] = "Загрузить набор"
L["ui.stats"] = "Статистика"
L["ui.trivia"] = "История"
L["ui.tttequip"] = "Экипировка TTT"
...
L["ttt.roundinfo.attmode"] = "Настройка режима частей оружия:"
...
L["ttt.roundinfo.bmode"] = "Информация о частях оружия на теле:"
...
L["ttt.bodyatt.found"] = "Вы думаете орудие убийства"
L["ttt.bodyatt.founddet"] = "С вашими детективными навыками вы выводите орудие убийства"
L["ttt.bodyatt.att1"] = " имел часть оружия {att} установленной."
L["ttt.bodyatt.att2"] = " имел {att1} и {att2} установленными."
L["ttt.bodyatt.att3"] = " имел следующие части оружия: "

L["ttt.attachments"] = " частей оружия: " -- Used in TTT2 TargetID
L["ttt.ammo"] = "Патр: " -- Used in TTT2 TargetID

-- Shit that used to be in CS+ why
L["info.togglesight"] = "Дважды нажмите + USE, чтобы переключить прицел"
L["info.toggleubgl"] = "Дважды нажмите +ZOOM, чтобы переключить подствольник"
