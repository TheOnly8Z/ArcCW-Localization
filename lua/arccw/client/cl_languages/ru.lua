...
L["arccw.cvar.hudpos_deadzone_x"]         = "Мертвая зона X"
L["arccw.cvar.hudpos_deadzone_y"]         = "Мертвая зона Y"
L["arccw.cvar.hudpos_deadzone.desc"]      = "Использовать ArcCW на вашем HDTV!"
...
L["arccw.blacklist"]                      = "Меню тёмного списка"
