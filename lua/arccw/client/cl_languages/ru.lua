...
-- ArcCW_Options_Ammo
L["arccw.cvar.ammo_detonationmode"]       = "Ра-ные боеприпасы"
...
L["arccw.cvar.mult_ammohealth"]           = "Здоровье ящиков (-1 неразрушаемы)"
...
L["arccw.cvar.visibility.desc"]           = "Части оружия не будут отображаться на таком расстоянии. -1 для постоянного отображения."
...
L["arccw.cvar.mult_attchance"]            = "Шанс случ-ой части оружия"
...
L["arccw.cvar.attinv_loseondie"]          = "Потеря част. оруж."
L["arccw.cvar.atts_pickx.desc"]           = "Выбор X позволяет установить ограничение на части оружия, которые можно разместить на любом оружии.\n0 = бесконечно."
L["arccw.cvar.atts_pickx"]                = "Выбор X"
L["arccw.cvar.enable_dropping"]           = "Части оружия выпадают"
...
L["arccw.cvar.ttt_bodyattinfo"]           = "Информ. о част. оруж. тела"
...
L["arccw.cvar.attinv_loseondie.2"]        = "2 - Выпадает ящик с частями оружия после смерти"
...
L["arccw.cvar.dev_showignored.desc"]      = "По умолчанию отключено.\nЗагрузить части оружия, для которых атрибут att.Ignore установлен в значение true. Эти части оружия могут быть сломаны или не реализованы."
...
L["arccw.cvar.mult_crouchdisp"]           = "Разброс в приседе"
L["arccw.cvar.mult_crouchrecoil"]         = "Отдача в приседе"